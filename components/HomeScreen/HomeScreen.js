    ...
    function renderMainCategories() {
        ...
        return (
            <View style={{ padding: SIZES.padding * 1 }}>
                ...
                <Text style={{ fontSize: 30, fontWeight: 'bold', }}>Menu All</Text>
            </View>
                            ...
                            item.categories.map((categoryId) => {
                                return (
                                    <View
                                        ...
                                        key={categoryId}
                                    >
                                        <Text style={{ fontSize: 14 }}>{getCategoryNameById(categoryId)}</Text>
                                        <Text style={{ fontSize: 14, color: COLORS.darkgray }}> . </Text>
                                    </View>
                                )
                            })
                        }
